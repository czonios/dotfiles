# Install tmux, neovim, exa, rust/cargo, ripgrep, htop, ncdu
# cargo install bottom (btm)
# sudo apt-get install zsh (or brew install zsh)
...
# maybe install starship if ohmyzsh and p10k are not enough
